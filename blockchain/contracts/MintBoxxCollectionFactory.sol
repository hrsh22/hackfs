...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/utils/structs/BitMaps.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/utils/structs/Checkpoints.sol
...
/*
    ...
    Useful for: Launching an NFT collection (e.g. a 10,000 profile pictures collection) with a minting website.

*/
contract MintBoxx is ERC721, Ownable, IERC2309 {
    ...
    constructor(
        ...
        _mintConsecutive(ownerAddress, 100);
        _tokenIds = 100;
    }
    ...
    function presaleMint() public payable {
        ...
        _tokenIds = tokenId;
        (bool sent, bytes memory data) = payable(ownerAddress).call{
            value: msg.value
        }("");
    ...
    function publicMint() public payable {
        require(
            ...
            "Public Sale is yet to begin"
        );
        require(publicMintPrice == msg.value, "Invalid Public Mint Price");
        uint256 tokenId = _tokenIds + 1;
        _safeMint(msg.sender, tokenId);
        _tokenIds = tokenId;
        (bool sent, bytes memory data) = payable(ownerAddress).call{
